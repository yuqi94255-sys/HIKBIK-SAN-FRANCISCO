...
struct GrasslandDetailView: View {
    ...
    var body: some View {
        ...
        .ignoresSafeArea(.all)
        .onAppear { isFavorite = FavoritesManager.shared.contains(id: "nationalgrassland:\(grassland.id)") }
        .sheet(isPresented: $showDetailSheet) {
            GrasslandDetailSheetContent(grassland: grassland, isFavorite: $isFavorite, themeColor: grasslandThemeColor)
