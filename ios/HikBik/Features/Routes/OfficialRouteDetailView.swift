...
struct OfficialRouteDetailView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            isLiked = ProfileLikedStore.isLiked(id: routeData.routeId)
    ...
    private var topBar: some View {
        HStack {
            ...
            Spacer()
            Button {
                ProfileLikedStore.toggle(id: routeData.routeId)
                isLiked = ProfileLikedStore.isLiked(id: routeData.routeId)
            } label: {
                Image(systemName: isLiked ? "heart.fill" : "heart")
                    .font(.system(size: 20))
                    .foregroundStyle(isLiked ? Color(hex: "EC4899") : HIKBIKTheme.textMuted)
            }
            .buttonStyle(.plain)
        }
