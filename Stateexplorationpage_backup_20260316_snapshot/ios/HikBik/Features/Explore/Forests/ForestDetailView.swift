...
struct ForestDetailView: View {
    ...
    var body: some View {
        ...
        .ignoresSafeArea(.all)
        .onAppear { isFavorite = FavoritesManager.shared.contains(id: "nationalforest:\(forest.id)") }
        .sheet(isPresented: $showDetailSheet) {
            ForestDetailSheetContent(forest: forest, isFavorite: $isFavorite, themeColor: forestThemeColor)
